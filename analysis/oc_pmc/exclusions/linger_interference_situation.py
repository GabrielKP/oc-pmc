...
def func_exclude_linger_interference_situation(
    config: Dict,
    ...
    # Mirrors pre reg: https://aspredicted.org/fps7-3n3f.pdf
...
def exclude_linger_interference_situation():
    aggregator(
        {
            "chosen_story": "carver_original",
            "chosen_condition": "interference_situation",
            "load_spec": get_load_spec(),
            "load_func": load_questionnaire,
            "call_func": func_exclude_linger_interference_situation,
            "aggregate_on": "all",
            "to_exclude_name": "interference_situation",
