...
def func_exclude_linger_interference_story_spr(
    config: Dict,
    ...
    # pre reg: https://aspredicted.org/dv9v-yqkx.pdf
    ...
    # 5. by time between reading phase and FA3 (70s)
...
def exclude_linger_interference_story_spr():
    to_compare_name = "neutralcue"
    aggregator(
        {
            "chosen_story": "carver_original",
            "chosen_condition": "interference_story_spr",
            "load_spec": get_comparison_load_spec(to_compare_name),
            "load_func": load_questionnaire,
            "call_func": func_exclude_linger_interference_story_spr,
            "aggregate_on": "all",
            "to_exclude_name": "interference_story_spr",
