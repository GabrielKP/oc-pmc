...
def func_exclude_linger_neutralcue2(
    config: Dict,
...
def exclude_linger_neutralcue2():
    to_compare_name = "button_press"
    aggregator(
        {
            "chosen_story": "carver_original",
            "chosen_condition": "neutralcue2",
            "load_spec": get_comparison_load_spec(to_compare_name),
            "load_func": load_questionnaire,
            "call_func": func_exclude_linger_neutralcue2,
            "aggregate_on": "all",
            "to_exclude_name": "neutralcue2",
