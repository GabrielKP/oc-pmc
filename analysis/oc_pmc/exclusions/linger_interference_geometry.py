...
def func_exclude_linger_interference_geometry(
    config: Dict,
    ...
    # pre-registration: https://aspredicted.org/yxvh-9dpp.pdf
...
def exclude_linger_interference_geometry():
    aggregator(
        {
            "chosen_story": "carver_original",
            "chosen_condition": "interference_geometry",
            "load_spec": get_load_spec(),
            "load_func": load_questionnaire,
            "call_func": func_exclude_linger_interference_geometry,
            "aggregate_on": "all",
            "to_exclude_name": "interference_geometry",
