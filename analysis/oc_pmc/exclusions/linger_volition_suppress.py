...
def func_exclude_carver_original_suppress(
    config: Dict,
...
def exclude_linger_volition_suppress():
    aggregator(
        {
            "chosen_story": "carver_original",
            "chosen_condition": "suppress",
            "load_spec": get_load_spec(),
            "load_func": load_questionnaire,
            "call_func": func_exclude_carver_original_suppress,
            "aggregate_on": "all",
            "to_exclude_name": "suppress",
