from oc_pmc.exclusions import exclude_linger_interference_geometry
...
q_keys = {
    ...
    "questionnaire_experience": [
        ...
        ("triangle_explanation", "triangle_explanation", "str"),
...
interference_answers = "geometry"


def do_import_linger_interference_geometry():
    success = import_data_json(
        "linger-interference-geometry",
        q_keys=q_keys,
