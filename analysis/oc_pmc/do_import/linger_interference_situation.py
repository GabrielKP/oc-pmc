from oc_pmc.exclusions import exclude_linger_interference_situation
...
q_keys = {
    ...
    "questionnaire_experience": [
        ...
        ("tom_explanation", "tom_explanation", "str"),
...
interference_answers = [
    ("interference_tom_testing", 3, "yes"),
    ("interference_tom_testing", 13, "no"),
]


def do_import_linger_interference_situation():
    success = import_data_json(
        "linger-interference-situation",
        q_keys=q_keys,
