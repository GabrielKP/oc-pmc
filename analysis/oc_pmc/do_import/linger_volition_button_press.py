...
from oc_pmc.exclusions import exclude_linger_volition_button_press
...
def do_import_volition_button_press():
    console.print("\nIMPORTING: button_press", style="red bold")
    import_data(
        "data_button_press_both_1",
        filter_condition="button_press",
        q_keys=q_keys,
        stage_keys=stage_keys,
        ratings=ratings,
    )
    console.print("\nEXCLUDING button_press", style="red bold")
