...
from oc_pmc.exclusions import exclude_linger_volition_button_press_suppress
from oc_pmc.import_data.import_data import import_data

q_keys = {
    "q_double_press_pre": [
        ("acc_button_press_food", "acc_button_press_food", "num"),
        ("freq_button_press_food", "freq_button_press_food", "str"),
        ("repetition_button_press_food", "repetition_button_press_food", "str"),
    ],
    "q_double_press_post": [
        ("acc_button_press_story", "acc_button_press_story", "num"),
        ("freq_button_press_story", "freq_button_press_story", "str"),
        ("repetition_button_press_story", "repetition_button_press_story", "str"),
    ],
    "q_demographics": [
    ...
    "q_experience1": [
        ...
        ("guess_suppress_2", "guess_suppress_2", "str"),
    ...
    "q_experience2": [
        ...
        ("wcg_diff_suppress", "wcg_diff_suppress", "str"),
        ("wcg_strategy_after_fail", "wcg_strategy_after_fail", "str"),
    ],
    "q_experience3": [
...
def do_import_linger_volition_button_press_suppress():
    console.print("\nIMPORTING: button_press_suppress", style="red bold")
    import_data(
        "data_button_press_both_1",
        filter_condition="button_press_suppress",
        q_keys=q_keys,
        stage_keys=stage_keys,
        ratings=ratings,
    )
    console.print("\nEXCLUDING button_press_suppress", style="red bold")
