from oc_pmc.exclusions import exclude_linger_interference_tom
...
interference_answers = [
    ("interference_tom_testing", 0, "yes"),
    ("interference_tom_testing", 7, "no"),
]


def do_import_linger_interference_tom():
    success = import_data_json(
        "linger-interference-tom",
        q_keys=q_keys,
